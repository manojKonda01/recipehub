...
const loadRecipeDetails = async () => {
  ...
  for (let i = 0; i < directions.length; i++) {
    directionsDOM += `<li><p>${randomText()} ${directions[i]}</p></li>`;
  }
  ...
  recipeDom.innerHTML = `
        <div class="recipe-head">
            ...
            <div class="recipe-tags">
                <span>${
                  recipeDetails.recipe['cuisineType']
                }</span><span> &gt </span>
                <span>${
                  recipeDetails.recipe['dishType']
                }</span><span> &gt </span>
            ...
            <figure id="recipe_fig">
                <img src="${recipeDetails.recipe['image']}" alt="${
            ...
            <div class="recipe-details">
                <div class="short-details">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="item-value">
                            ${recipeDetails.recipe['totalWeight'].toFixed(
                              0
                            )} gms
                        </div>
                    </div>
                    ...
                    <div id="nutrition_facts">
                        ...
                        <div class="fact">
                            <div>
                                ...
                                <span class="value quantity">${recipeDetails.recipe[
                                  'totalNutrients'
                                ]['FAT']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalNutrients']['FAT'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                            <div>
                                <span class="value">${recipeDetails.recipe[
                                  'totalDaily'
                                ]['FAT']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalDaily']['FAT'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                        ...
                        <div class="fact">
                            <div>
                                ...
                                <span class="value quantity">${recipeDetails.recipe[
                                  'totalNutrients'
                                ]['CHOLE']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalNutrients'][
                                    'CHOLE'
                                  ]['unit']
                                }</span>
                            </div>
                            <div>
                                ...
                                <span class="value">${
                                  recipeDetails.recipe['totalDaily']['CHOLE'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                        ...
                        <div class="fact">
                            <div>
                                ...
                                <span class="value quantity">${recipeDetails.recipe[
                                  'totalNutrients'
                                ]['CHOCDF']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalNutrients'][
                                    'CHOCDF'
                                  ]['unit']
                            ...
                            <div>
                                ...
                                <span class="value">${
                                  recipeDetails.recipe['totalDaily']['CHOCDF'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                        ...
                        <div class="fact">
                            <div>
                                ...
                                <span class="value quantity">${recipeDetails.recipe[
                                  'totalNutrients'
                                ]['PROCNT']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalNutrients'][
                                    'PROCNT'
                                  ]['unit']
                            ...
                            <div>
                                ...
                                <span class="value">${
                                  recipeDetails.recipe['totalDaily']['PROCNT'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                        ...
                        <div class="fact">
                            <div>
                                ...
                                <span class="value quantity">${recipeDetails.recipe[
                                  'totalNutrients'
                                ]['NA']['quantity'].toFixed(0)}</span>
                                <span class="value">${
                                  recipeDetails.recipe['totalNutrients']['NA'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                            <div>
                                ...
                                <span class="value">${
                                  recipeDetails.recipe['totalDaily']['NA'][
                                    'unit'
                                  ]
                                }</span>
                            </div>
                        ...
                        <div class='vitamin-facts'>
                            <div class="fact">
                                ...
                                <div>
                                    ...
                                    <span class="value">${
                                      recipeDetails.recipe['totalDaily']['CA'][
                                        'unit'
                                      ]
                                    }</span>
                                </div>
                            ...
                            <div class="fact">
                                ...
                                <div>
                                    ...
                                    <span class="value">${
                                      recipeDetails.recipe['totalDaily']['FE'][
                                        'unit'
                                      ]
                                    }</span>
                                </div>
                            ...
                            <div class="fact">
                                ...
                                <div>
                                    ...
                                    <span class="value">${
                                      recipeDetails.recipe['totalDaily']['K'][
                                        'unit'
                                      ]
                                    }</span>
                                </div>
                            ...
                            <div class="fact">
                                ...
                                <div>
                                    ...
                                    <span class="value">${
                                      recipeDetails.recipe['totalDaily'][
                                        'VITC'
                                      ]['unit']
                                    }</span>
                                </div>
  ...
  document
    .getElementById('nutrition_title')
